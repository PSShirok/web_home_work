                ...
                <div class="col-4">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="w-100 btn btn-lg btn-outline-dark btn-success">Купить</button>
                        </div>
                    </div>
                    ...
                    <div class="col-6">
                        <label for="exampleFormControlInput1" class="form-label">Укажите ваши данные, мы с вами свяжемся</label>
                        <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="Иванов Иван Иванович">
                        <input type="email" class="form-control mt-4" id="exampleFormControlInput2" placeholder="name@example.com">
                        <button type="button" class="w-100 btn btn-lg btn-outline-dark btn-success mt-5">Заказать</button>
                    </div>
                <div class="col-12">
                    <label for="exampleFormControlInput1" class="form-label">Раздел FAQ</label>
  ...
  <div class="col">
    <div class="collapse multi-collapse" id="multiCollapseExample1">
      <div class="card card-body">
        Введите ваши данные мы с вами свяжемся
      </div>
    </div>
  </div>
  <div class="col">
    <div class="collapse multi-collapse" id="multiCollapseExample2">
      <div class="card card-body">
        Мы позаботились о Вас, мы доставим вам товар прям до двери
      </div>
    </div>
  </div>
    <div class="col">
    <div class="collapse multi-collapse" id="multiCollapseExample3">
      <div class="card card-body">
        100% возвврат денежных средств, если вас не устроит товар
      </div>
    </div>
  </div>
</div>
...
<script>
    ...
    def do_GET(self):
        ...
        page_cont = self.__get_html_content()
        self.send_response(200) # Отправка кода ответа
        self.send_header("Content-type", "text/html") # Отправка типа данных, который будет передаваться
        self.end_headers() # Завершение формирования заголовков ответа
        self.wfile.write(bytes(page_cont, "utf-8")) # Тело ответа
